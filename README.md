...
Help: ChatGPT Helped by provided a binary search code example which helped further my understanding of what binary search looks like in code form. I then wrote my own code to sattisfy the requirements of the excercise.
